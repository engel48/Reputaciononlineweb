...
export const login = async (email: string, password: string): Promise<LoginResponse> => {
  try {
    ...
    const userResponse: User = {
      ...
      partidoPolitico: user.partidoPolitico ?? user.partido_politico,
      cargoActual: user.cargoActual ?? user.cargo_actual,
      propuestasPrincipales: user.propuestasPrincipales ?? user.propuestas_principales,
