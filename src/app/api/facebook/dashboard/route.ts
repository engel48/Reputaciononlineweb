...
/**
 * Dashboard de Facebook - Datos consolidados para visualización
 *
 * GET /api/facebook/dashboard
 *
 * Retorna:
 * - Métricas de la página (seguidores, posts, engagement)
...
export async function GET(request: NextRequest) {
  try {
    console.log('📊 Facebook Dashboard: Generando datos...');
    ...
    const dashboard = {
      ...
      data: {
        ...
        page: {
          ...
          name: socialMedia.display_name || 'Página de Facebook',
    ...
    console.log('✅ Dashboard de Facebook generado exitosamente');

    return NextResponse.json(dashboard);

  } catch (error: any) {
    console.error('❌ Error generando dashboard de Facebook:', error);
    return NextResponse.json(
