...
import {
  ...
  Facebook, Instagram, Twitter, Youtube, Search, Users, Building2
} from 'lucide-react';
...
type TabType = 'search' | 'all' | 'news' | 'social' | 'hashtags';

const tabs: { id: TabType; label: string; icon: React.ReactNode }[] = [
  { id: 'search', label: 'Búsqueda Personas/Empresas', icon: <Search className="h-4 w-4" /> },
  { id: 'all', label: 'Monitoreo', icon: <BarChart3 className="h-4 w-4" /> },
...
export default function MonitoreoPage() {
  ...
  const initialTab = (searchParams.get('tab') as TabType) || 'search';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Busca personas, empresas, políticos e influencers. Monitorea menciones en tiempo real.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <span className="text-sm text-blue-700 dark:text-blue-300">Políticos</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              <Users className="h-4 w-4 text-purple-600 dark:text-purple-400" />
              <span className="text-sm text-purple-700 dark:text-purple-300">Influencers</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <Building2 className="h-4 w-4 text-green-600 dark:text-green-400" />
              <span className="text-sm text-green-700 dark:text-green-300">Empresas</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-2">
          ...
          {/* Botón de refrescar - solo visible en tabs de monitoreo */}
          {activeTab !== 'search' && (
            <button
        ...
        {activeTab === 'search' ? (
          /* Búsqueda avanzada de personas y empresas */
          <div className="mb-8">
            <AdvancedSearch />
          </div>
        ) : (
            ...
            {showFilters && (
              <div className="bg-white dark:bg-gray-800 rounded-xl p-4 mb-6 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {activeTab !== 'news' && activeTab !== 'search' && (
                    <div>
