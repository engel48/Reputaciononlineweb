...
export const NEWS_SITES_CONFIG: NewsSiteConfig[] = [
  // ========== MEDIOS NACIONALES (10) ==========
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.eltiempo.com/rss.xml',
    isActive: true,
  ...
  },
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.semana.com/rss/',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.rcnradio.com/rss',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.caracol.com.co/rss.xml',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.bluradio.com/rss',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.wradio.com.co/rss.xml',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
    ...
    category: 'nacional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.lafm.com.co/rss',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
  ...
  },
  {
    ...
    category: 'regional',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.elheraldo.co/rss',
    isActive: true,
    maxRequestsPerHour: 12,
  },
  {
  ...
  // ========== MEDIOS DIGITALES (10) ==========
  {
    ...
    category: 'digital',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.pulzo.com/rss',
    isActive: true,
  ...
  },
  {
    ...
    category: 'digital',
    scrapingMethod: 'rss',
    rssUrl: 'https://www.infobae.com/colombia/rss.xml',
    isActive: true,
    maxRequestsPerHour: 15,
  },
  {
